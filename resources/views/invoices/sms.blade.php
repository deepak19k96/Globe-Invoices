<div class="modal fade" id="smsModal" tabindex="-1" role="dialog" aria-labelledby="emailModalLabel" aria-hidden="true" style="z-index:10000">
    <div class="modal-dialog">
        <div class="modal-content" style="background-color: #f8f8f8">

            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="emailModalLabel">{{ trans('texts.sms_invoice') }}</h4>
            </div>
            ...
            <div class="container" style="width: 100%; padding-bottom: 0px !important">
                ...
                <div class="modal-footer" style="margin-top: 2px; padding-right:0px">
                    ...
                    <button id="sendSMSButton" type="button" class="btn btn-info" onclick="onConfirmEmailClick()">{{ trans('texts.send_email') }}</button>
                </div>
            </div>
        </div>
    </div>
